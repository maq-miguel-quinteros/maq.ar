...
const Birthday = () => {
    ...
    const timelineData = [
        ...
        { time: "23:00 - 23:40", event: "Arranca el folcklore (se baila o se baila) con ", name:'David Robles', contact:'https://www.instagram.com/davidrobles.oficial/' },
        ...
        { time: "03:00 - 03:10", event: "Piñata, no es cumpleaños sin piñata"},
        { time: "01:15 - 04:30", event: "Rock, cumbia, cuarteto, cachengue y cachengue... ¿alguien pidió cachengue? de la mano de ", name:'Dj Jose Morales', contact: 'https://www.instagram.com/josemorales.ok/' },
