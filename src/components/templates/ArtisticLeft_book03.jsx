                        ...
                        <li>
                            <div className='flex items-center gap-2'>
                                ...
                                <ArtisticBookItem
                                    ...
                                    <span className='dark:hover:bg-sky-700 hover:bg-sky-700 hover:text-sky-50'>
                                        La Casa de los Espejos</span>
                                </ArtisticBookItem>
                            </div>
                            <span className='text-xs font-light'>Divino Desorden Ediciones. ISBN: 978-631-91366-0-9</span>
                        </li>
                        <li >
                            <div className='flex items-center gap-2'>
